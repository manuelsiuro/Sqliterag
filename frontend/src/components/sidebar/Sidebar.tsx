...
export function Sidebar() {
  ...
  return (
    <aside
      className={`${sidebarCollapsed ? "w-14" : "w-48"} bg-gray-900 border-r border-gray-800 flex flex-col h-full transition-all duration-200 shrink-0`}
    >
      {/* Toggle button */}
      <button
      ...
      <nav className="p-2 space-y-1">
        {navItems.map((item) => (
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors"
